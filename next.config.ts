...
const nextConfig: NextConfig = {
  ...
  env: {
    ...
    APP_API_EVALUATION_SERVICE_LOCAL:
      process.env.APP_API_EVALUATION_SERVICE_LOCAL,
    APP_API_ACADEMIC_SERVICE_LOCAL: process.env.APP_API_ACADEMIC_SERVICE_LOCAL,
    APP_API_ECONOMIC_SERVICE_LOCAL: process.env.APP_API_ECONOMIC_SERVICE_LOCAL,
    //deployed APIs
    ...
    APP_API_EVALUATION_SERVICE: process.env.APP_API_EVALUATION_SERVICE,
    APP_API_ACADEMIC_SERVICE: process.env.APP_API_ACADEMIC_SERVICE,
    APP_API_ECONOMIC_SERVICE: process.env.APP_API_ECONOMIC_SERVICE,
